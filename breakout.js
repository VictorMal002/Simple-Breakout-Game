...
function preload() {
    ...
    this.load.image('destroyed', 'destroyed.png');
    this.load.image('ball', 'all.png');
}
...
function create() {
    ...
    gameOverText = this.add.text(this.cameras.main.centerX, this.cameras.main.centerY, 'Game over!', textStyle)
        ...
        .on('pointerover', () => wonTheGameText.setStyle({ fill: '#f39c12' }))
        .on('pointerout', () => wonTheGameText.setStyle({ fill: '#FFF' }))
        .setVisible(false);
